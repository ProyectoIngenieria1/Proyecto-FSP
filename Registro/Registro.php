...
<body id="home">
  ...
  <!-- inicio div CREAR UNA CUENTA -->

   <div id="CREAR UNA CUENTA" class="content-section-b" style="border-top: 0">
    <div class="container">
        ...
        <form class="form-horizontal">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control"  id="name" spellcheck="false" placeholder="Juan Perez Mendoza"/>
               ...
               <div class="form-group">
              <label for="name" class="col-lg-5 control-label">Fecha de nacimiento:</label>
              <div class="col-lg-4">
              <input type="text" class="form-control"  id="date" spellcheck="false" placeholder=" "/>
            </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
              <label for="password-again" class="col-lg-5 control-label" >Confirmar Contraseña:</label>
              <div class="col-lg-4">
            ...
            <div>
              <label></label>
              <input type="submit" value="Registrarse" id="Registrarse" class="button"/>
            </div>
